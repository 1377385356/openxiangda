    ...
    browser: {
      ...
      properties: {
        ...
        fileIntent: {
          ...
          properties: {
            recordResourceCode: dataResourceCode,
            recordIdInputField: dataFieldCode,
            relationField: dataFieldCode,
            fileNameField: dataFieldCode,
            contentTypeField: dataFieldCode,
            sizeField: dataFieldCode,
            purposes: {
              type: "array",
              minItems: 1,
              maxItems: 2,
              uniqueItems: true,
              items: { enum: ["preview", "download"] },
            },
            maxTtlSeconds: { type: "integer", minimum: 1, maximum: 300 },
      ...
      items: {
        ...
        properties: {
          ...
          schedule: {
            ...
            properties: {
              campusPolicyCode: stableCode,
              rulePolicyCode: stableCode,
              campusField: dataFieldCode,
              ruleCampusField: dataFieldCode,
              ruleWeekdaysField: dataFieldCode,
              ruleOpenAtField: dataFieldCode,
              ruleCloseAtField: dataFieldCode,
              ruleSlotMinutesField: dataFieldCode,
              ruleAdvanceHoursField: dataFieldCode,
              ruleAdvanceDaysField: dataFieldCode,
              campusEnabledField: dataFieldCode,
              ruleEnabledField: dataFieldCode,
              dateField: dataFieldCode,
              timeField: dataFieldCode,
            },
          },
