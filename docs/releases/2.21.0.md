# OpenXiangda 2.21.0：Agent 原生视觉开发流程

移除效果和维护成本不匹配的 OpenDesign 运行时、命令与桥接层，把界面设计收敛为同一 AI Agent 内完成的闭环：按需使用 Image 2.5 等图片能力生成少量视觉参考，直接实现真实 React 页面，并以浏览器交互证据完成修正和验收。
...
更新说明摘要：`18c7d0d0c508dec38ab1685d649103dcd820c75203d4a67eddd9c17aabc7651d`
